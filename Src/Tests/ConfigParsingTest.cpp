...
int main(int argc, char** argv)
{
    ...
    //TODO(NOW)
    //If version file exists and up to date, writeDefaultConfigs flag should be false
    //If version file exists and not up to date, writeDefaultConfigs flag should be true
    //If version file doesn't exist, writeDefaultConfigs flag should be true
